...
| license_number | VARCHAR(50) | NOT NULL, UNIQUE | Номер лицензии |
...
| Поле | Тип | Ограничения | Описание |
|------|------|-------------|-----------|
| polis_id | INT | PRIMARY KEY, NOT NULL, FOREIGN KEY REFERENCES POLIS(polis_id) | ID полиса |
| insurance_id | INT | PRIMARY KEY, NOT NULL, FOREIGN KEY REFERENCES INSURANCE(insurance_id) | ID страховой компании |
...
|------|------|-------------|-----------|
| polis_id | INT | PRIMARY KEY, NOT NULL, FOREIGN KEY REFERENCES POLIS(polis_id) | ID полиса |
| tech_id | INT | PRIMARY KEY, NOT NULL, FOREIGN KEY REFERENCES TECHNICH(tech_id) | ID оборудования |
...
|------|------|-------------|-----------|
| polis_id | INT | PRIMARY KEY, NOT NULL, FOREIGN KEY REFERENCES POLIS(polis_id) | ID полиса |
| doctor_id | INT | PRIMARY KEY, NOT NULL, FOREIGN KEY REFERENCES DOCTOR(doctor_id) | ID врача |
